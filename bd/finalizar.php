        ...
        <form action="" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="inputAddress"
                    placeholder="Rua dos Bobos, nº 0, bl.0 apto. 00" name="endereco" value="<?php echo $row['endereco'] ?>" required>
            </div></br>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="inputCity">Cidade</label>
                    <input type="text" class="form-control" id="inputCity" placeholder="Mogi das Cruzes" name="cidade" value="<?php echo $row['cidade'] ?>" required>
                </div>
                <div class="form-group col-md-4">
                    <label for="inputEstado">Estado</label>
                    <select name="estado" id="inputEstado" class="form-control" required>
                        <option <?php if($row['estado'] == NULL){echo 'selected';}?> value="" disabled>Selecione</option>
                        <option <?php if($row['estado'] == 'DF'){echo 'selected';}?> value="DF">DF</option>
                        <option <?php if($row['estado'] == 'MG'){echo 'selected';}?> value="MG">MG</option>
                        <option <?php if($row['estado'] == 'RJ'){echo 'selected';}?> value="RJ">RJ</option>
                        <option <?php if($row['estado'] == 'RS'){echo 'selected';}?> value="RS">RS</option>
                        <option <?php if($row['estado'] == 'SP'){echo 'selected';}?> value="SP">SP</option>
                    </select>
                </div></br>
                <div class="form-group col-md-2">
                    <label for="inputCEP">CEP</label>
                    <input type="cep" class="form-control" placeholder="00000-000" name="cep" value="<?php echo $row['cep'] ?>" required>
                </div>
                </br>
                </br>
                <div>
